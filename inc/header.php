                    ...
                    <div class="col-md-6 text-end">
                        ...
                        <nav class="navbar nav-shift">
                            <ul class="navbar-ul" id="navList">
                                <li class="nav-item active"><a class="navbar-link" href="navbar.php">Home</a></li>
                                <li class="nav-item"><a class="navbar-link" href="about-us.php">About</a></li>
                                <li class="nav-item dropdown submenu">
                                    <a class="navbar-link btn btn-secondary dropdown-toggle" href="services-page.php"
                                        role="button" id="dropdownMenuLink" data-bs-toggle="dropdown"
                                        aria-expanded="false">Services <i class="fa-solid fa-chevron-down"></i></a>
