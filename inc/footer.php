		...
		<div class="modal-content wrap-all-modal">
			...
			<div class="modal-body">
				<div class="call-text-btn">
					<button><i class="fa-solid fa-phone"><a href="tel:780-937-6666"> Call Us</a></i></button>
					<button><i class="fa-regular fa-comments"><a href="sms:780-937-6666">Text Us</a></i></button>
				</div>
			</div>
