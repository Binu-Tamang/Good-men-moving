                    ...
                    <div class="col-lg-4 d-lg-block">
                        <div class="contact-details-box">
                            ...
                            <p class="good-man-moving-p aos-init aos-animate">"The Professional Muscular Edmonton
                                ...
                                <br> <a aria-label="mail us now" href="mail:goodmenmovingco@gmail.com">goodmenmovingco@gmail.com</a>
                            </p>
                            <a aria-label="call us now" href="tel:780-937-6666"><i class="fa-solid fa-phone"></i> 780-937-6666</a> <br>
                            <a aria-label="time we are avaiable" href="#"><i class="fa-regular fa-clock"></i> 24 Hours Services</a>
                            <div class="contact-social-media">
                                <ul>
                                    <li class="li-h-1"><a aria-label="about our facebook page" target="_blank"
                                            href="https://www.facebook.com/profile.php?id=100089283152732"><i
                                                class="fa-brands fa-facebook-f"></i></a>
                                    </li>
                                    <li><a aria-label="about our pinterest" target="_blank" href="https://www.pinterest.com/goodmenmovingcompany/"><i
                                                class="fa-brands fa-pinterest-p"></i></a></li>
                                    <li><a aria-label="about our location" href="#"><i class="fa-solid fa-location-dot"></i></a>
                                    </li>
                                </ul>
                            </div>
