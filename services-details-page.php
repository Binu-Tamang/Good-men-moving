                    ...
                    <div class="container">
                        <div class="services-details-menu">
                            ...
                            <ul class="services-menu-list">
                                <li><a href="#serve-1"><i class="fa-solid fa-people-carry-box"></i> Local Moves</a>
                                </li>
                                <li><a href="#serve-2"><i class="fa-solid fa-truck-moving"></i> Long Distance
                                        Moves</a>
                                </li>
                                ...
                                <li><a href="#serve-5"><i class="fa-solid fa-business-time"></i>
                                        Assembly/Disassembly</a>
                                </li>
                                <li><a href="#serve-6"><i class="fa-solid fa-dolly"></i> Packing/Equipment</a>
                                </li>
                                <li><a href="#serve-7"><i class="fa-solid fa-boxes-packing"></i> Packing And
                                        Unpacking</a>
                                </li>
                                <li><a href="#serve-8"><i class="fa-solid fa-reply-all"></i> Available Storage
                                        Facilities</a>
                                </li>
